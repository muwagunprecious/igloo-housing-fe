...
import {
    ...
    Users,
    FileWarning,
    Menu // <-- Don't forget to import Menu!
} from "lucide-react";
...
// Accept the onMenuClick prop with proper TypeScript typing
export default function AdminNavbar({ onMenuClick }: { onMenuClick?: () => void }) {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-[80px] bg-white/80 backdrop-blur-md border-b border-gray-100 z-[100] px-4 md:px-8">
            <div className="max-w-[2520px] mx-auto h-full flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 sm:gap-6 ml-auto">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-3 sm:pl-2 sm:pr-4 sm:py-2 bg-gray-50 rounded-2xl border border-gray-100 hover:border-black/10 transition-all"
                        >
                            ...
                            <ChevronDown size={14} className={`text-gray-400 transition-transform hidden sm:block ${showProfile ? 'rotate-180' : ''}`} />
                        </button>
